...
VALUES
    ...
    ('Jane Smith1', 'janes1mith', 'jane@examp1le.com', 'p@ssw10rd', 'Tech enth1usiast', 'images/xSHEr42ExnTkF65eLIJtvlwAumV6O6B4t0ZeeJ5e.png', 'user'),
    ('Admin User', 'admin', 'admin@example.com', '$2y$10$ONfUdIrLOFfApp4VSIFvBOZL/ViR2t0HdbPa9xQmrsqvaAZtMVf2y', 'Administrator', 'images/xSHEr42ExnTkF65eLIJtvlwAumV6O6B4t0ZeeJ5e.png', 'admin'),
