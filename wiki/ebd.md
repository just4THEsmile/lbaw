...
|identifier| name         | Magnitude               |
|RS1| user                | 10.000                                  ||
|RS2| admin               | Relation where the index is applied    ||
|RS3| **Attribute**       | Attribute where the index is applied   ||
|RS4| **Type**            | B-tree, Hash, GiST or GIN              ||
|RS5| **Cardinality**     | Attribute cardinality: low/medium/high ||
|RS6| **Clustering**      | Clustering of the index                ||
|RS7| **Justification**   | Justification for the proposed index   ||
|RS8| `SQL code`                                                  ||
